...
通过**代码/js效果演示**提供资料进行效果演示，js可以让我们的页面更加的智能，让页面和用户进行交互。 
...
按照基本语法规则，编写3种输出语句的代码，并且添加注释，具体代码如下；
...
![1668101592422](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191050122.png) 
...
![1668101718354](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191049059.png) 
...
![image-20231019104915041](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191049134.png)
...
![1668101996370](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191051311.png) 
...
![1668102183766](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191051425.png) 
...
![1668102256305](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191052060.png) 
...
![1668102426953](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191052701.png)

接着我们使用let重复定义变量，代码修改如下：发现idea直接帮我们报错了，说明let声明的变量不能重复定义

![1668102527993](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191052841.png) 
...
![1668102736759](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191053151.png) 
...
![1668103531260](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191053464.png) 
...
**需要注意的是：**在js中，`0`，`null`，`undefined`，`""`，`NaN`理解成`false`，反之理解成`true`
...
在java中我们为了提高代码的复用性，可以使用方法。同样，在JavaScript中可以使用函数来完成相同的事情。JavaScript中的函数被设计为执行特定任务的代码块，通过关键字function来定义
...
![1668584359136](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191056117.png) 
...
![1668587524509](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191057478.png)



然后进入到如下界面，点击右侧的参考书

![1668587661914](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191058254.png )



然后进入到如下页面，此页面列举出了JavaScript中的所有对象

![1668587855863](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191100020.png)
...
![1668587953841](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191100256.png) 

第二类：BOM对象,主要是和浏览器相关的几个对象

![1668588039871](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191102059.png) 

第三类：DOM对象，JavaScript中将html的每一个标签都封装成一个对象

![1668588141399](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191102318.png) 
...
![1668590655291](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191103238.png) 
...
![1668590614787](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191103002.png) 
...
![1668590895662](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191104548.png) 
...
- length属性：
  ...
  ![1668591566013](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191105989.png) 
...
- forEach()函数
  ...
  ![1668592407223](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191105875.png)  
...
- push()函数
  ...
  ![1668593799333](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191105155.png) 
...
- splice()函数
  ...
  ![1668594075039](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191105103.png) 
...
![1668595022160](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191106529.png) 
...
![1668595450181](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191106531.png) 
...
![1668596039535](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191107887.png)
...
![1668596701343](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191107602.png) 

但是当我们将双引号切换成单引号，再次校验，则报错，如下图所示：

![1668596798551](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191107706.png)
...
![1668597000013](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191108582.png) 
...
![1668597176685](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191108859.png) 
...
![1668597352197](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191108818.png) 
...
![1668597489911](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191108565.png) 
...
![1668597624263](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191108035.png) 
...
![image-20210815194911914](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191109441.png) 
...
- alert()函数：弹出警告框，函数的内容就是警告框的内容
  ...
  ![1668794735581](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191109169.png) 
...
- confirm()函数：弹出确认框，并且提供用户2个按钮，分别是确认和取消。
  ...
  ![1668794898891](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191110953.png) 
...
- setInterval(fn,毫秒值)：定时器，用于周期性的执行某个功能，并且是**循环执行**。该函数需要传递2个参数：
  ...
  ![1668795435780](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191110375.png) 
...
![1668796236628](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191110804.png) 
...
![1668796698067](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191111983.png) 
...
- document.getElementById()： 根据标签的id属性获取标签对象，id是唯一的，所以获取到是单个标签对象。
  ...
  ![1668798266255](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191112410.png) 
...
- document.getElementsByTagName() :  根据标签的名字获取标签对象，同名的标签有很多，所以返回值是数组。
  ...
  ![1668799227223](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191112016.png) 
...
- document.getElementsByName() ：根据标签的name的属性值获取标签对象，name属性值可以重复，所以返回值是一个数组。
  ...
  ![1668799393592](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191112347.png)  
...
- 操作属性
  ...
  ![1668800047162](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191113533.png) 
  ...
  ![1668800387791](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191116614.png) 
...
![1668802830796](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191116107.png) 
...
- 方式1：通过html标签中的事件属性进行绑定
  ...
  ![1668804375833](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191119633.png) 
...
- 方式2：通过DOM中Element元素的事件属性进行绑定
  ...
  ![1668804696373](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191120617.png) 
...
- onfocus:获取焦点事件，鼠标点击输入框，输入框中光标一闪一闪的，就是输入框获取焦点了
  ...
  ![1668805346551](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191120828.png)

- onblur:失去焦点事件，前提是输入框获取焦点的状态下，在输入框之外的地方点击，光标从输入框中消失了，这就是失去焦点。

  ![1668805498416](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310191120637.png) 
