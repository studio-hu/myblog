...
![1668051403591](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310100944711.png)
...
![1668052028054](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310101049128.png)
...
![1668052307537](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310100944439.png)

我们再尝试，把join()方法去掉，再看执行效果。此时你会发现2号线程没有执行完1号线程就执行了**（效果是多次运行才出现的，根据个人电脑而异，可能有同学半天也出现不了也是正常的）**

![1668052414444](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310101049492.png)
...
![1668059112092](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310101051912.png)
...
![1668059997020](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310100944172.png)
...
![1668060312733](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310100944458.png)

等小红线程执行完了，把余额改为0，出去了就会释放锁。这时小明线程就可以加锁进来执行，如下图所示。

![1668060382390](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310100944473.png)
...
![1668064583299](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310101052064.png)
...
![1668065892511](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310100944686.png)



但是任务总有被执行完的时候，假设第1个线程的任务执行完了，那么第1个线程就空闲下来了，有新的任务时，空闲下来的第1个线程可以去执行其他任务。依此内推，这3个线程可以不断的复用，也可以执行很多个任务。

![1668066073126](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310101052951.png)
...
![1668066279649](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310101052527.png)
...
![1668066844202](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310101052407.png)
...
![1668067745116](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310101052686.png)
...
![1668067798673](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310100944851.png)
...
![1668067964048](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310100944934.png)
...
![1668068110593](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310100944042.png)
...
![1668068399363](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310100944455.png)
...
![1668069176927](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310100944329.png)
...
![1668069524799](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310100944634.png)
...
![1668069740969](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310101053111.png)

接下来就来学习线程的生命周期。在Thread类中有一个嵌套的枚举类叫Thread.Status，这里面定义了线程的6中状态。如下图所示

![1668069923403](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310101053407.png)
...
![1668070204768](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202310101053576.png)
