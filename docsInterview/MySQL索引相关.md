...
![图片](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202401251937257.png)

## 1. 索引是什么？

![图片](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202401251938493.png)
...
![图片](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202401251938164.png)
...
- B+树非叶子节点上是不存储数据的，仅存储键值，而 B 树节点中不仅存储 键值，也会存储数据。innodb 中页的默认大小是 16KB，如果不存储数据，那 么就会存储更多的键值，相应的树的阶数（节点的子节点树）就会更大，树就 会更矮更胖，如此一来我们查找数据进行磁盘的 IO 次数又会再次减少，数据查 询的效率也会更快。
...
![图片](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202401251938443.png)

再画出`id`主键索引，我们先画出聚族索引结构图，如下：

![图片](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202401251938181.png)
...
![图片](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202401251939356.png)

这个SQL:` select * from employee where name like '小%' order by age desc;` 也是命中索引的。

![图片](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202401251939262.png)
...
![图片](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202401251939176.png)
...
![图片](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202401251939601.png)
...
![图片](https://cdn.jsdelivr.net/gh/studio-hu/drawingBed/img/202401251940123.png)
